% This script designs an R-Square audit with replacement beginning with 
...
ExpectedPolledBallots = dot(StopSchedR2,RoundSchedFull); 
...
RiskValueR2
ExpectedBallotsR2
ExpectedBallotsWithCost
ExpectedPolledBallots 
