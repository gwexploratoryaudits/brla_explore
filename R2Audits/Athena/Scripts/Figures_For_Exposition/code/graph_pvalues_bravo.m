% This script graphs the Bravo pvalues in the first round
%---
% Required input is
%       p: winner fraction
...
% Bravo p-value 
first_plot = plot((begin_from:end_at), pvalue_bravo, 's-', ...
   'Color', dull_green, 'LineWidth', 2);
hold
...
title('Bravo p-value as a function of winner ballots', 'FontSize', 16) 

% Legend
legend(vertcat(first_plot), 'Bravo p-value', ...
