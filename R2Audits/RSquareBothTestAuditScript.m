...
ExpectedBallotsR2BRAVOPolled = dot(StopSchedR2BRAVO,RoundSched)
ExpectedBallotsB2BRAVOPolled = dot(StopSchedB2BRAVO,RoundSched)
RiskValueR2BRAVOLike
RiskValueB2BRAVOLike
ExpectedBallotsBRAVOLikeTrue
ExpectedBallotsR2BRAVOLike
ExpectedBallotsB2BRAVOLike
ExpectedBallotsR2BRAVOLikePolled = dot(StopSchedR2BRAVOLike,RoundSched)
ExpectedBallotsB2BRAVOLikePolled = dot(StopSchedB2BRAVOLike,RoundSched)
...
title('Cumulative Stopping probabilities for margin=0.1, risk limit=0.1, N=14,000')
...
title('Cumulative (Maximum) Risk Expenditure for margin=0.1, risk limit=0.1, N=14,000')
legend('Theoretical BRAVO audit (Goal)','BRAVO as currently done','Proposed Audit','Theoretical BRAVOLike audit (Goal)','BRAVOLike as currently done','Proposed Audit', 'Location', 'South')
