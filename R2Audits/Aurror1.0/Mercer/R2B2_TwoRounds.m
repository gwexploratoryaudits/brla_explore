...
kmin_one_round = binoinv(1-RiskValue, max_polled_ballots_voted, 0.5);
RiskValue_one_round = binocdf(kmin_one_round, max_polled_ballots_voted, 0.5, 'upper');
StopProb_one_round = binocdf(kmin_one_round, max_polled_ballots_voted, p, 'upper');
